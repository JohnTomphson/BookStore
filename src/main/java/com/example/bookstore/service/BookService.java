...
public class BookService implements Crud {
    ...
    public ApiResponse add(BookDTO bookDTO) {
        ...
        bookRepo.save(book);
        return ApiResponse.builder().success(true).message("Saved").build();

    }


    public ApiResponse update(Integer id,BookDTO bookDTO) {
        Optional<Book> bookOptional = bookRepo.findById(id);
    ...
    public Book addForDataloaderBook(
            Sinf sinf,
            Category category, String description,
            String avtor, Language language) {

        Book book = new Book();
        book.setSinf(sinf);
        book.setDiscription(description);
